...
public final class KeYUniverseProvider extends ExportAdapter {
  private static String ADAPTER_NAME = "key-universe-provider";
  ...
  public void performForPath(Path p, Dir finalDir) {
    try {
      ...
      var results = trans.translateContractLibAst(ast, true);
